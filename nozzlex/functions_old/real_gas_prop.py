...
class Fluid:
    ...
    def compute_properties_2phase(self):
        ...
        drhodp_L = temp.first_saturation_deriv(CP.iDmass, CP.iP)
        drhodh_L = - (rho_L**2/T_mix) * temp.first_saturation_deriv(CP.iT, CP.iP)
        ...
        drhodp_V = temp.first_saturation_deriv(CP.iDmass, CP.iP)
        drhodh_V = - (rho_L**2/T_mix) * temp.first_saturation_deriv(CP.iT, CP.iP)
