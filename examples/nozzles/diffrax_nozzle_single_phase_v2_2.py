...
def nozzle_single_phase(
    ...
    y0 = jnp.array([x_in, p_in, v_in, h_in]) # with p, h input
    # y0 = jnp.array([x_in, v_in, rho_in, p_in]) # with p, rho input
...
if __name__ == "__main__":
    ...
    print("-" * 60)
    input_array = jnp.asarray([0.1, 0.15, 0.20, 0.25, 0.30, 0.35, 0.4, 0.45, 0.50])
