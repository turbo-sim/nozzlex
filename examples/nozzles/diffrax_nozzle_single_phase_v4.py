...
# v4 is a copy of v2 but trying to solve it for Nakagawa case with HEM
...
if __name__ == "__main__":
    ...
    print("\n" + "-" * 60)
    print("Running inlet Mach number sensitivity anwalysis")
    print("-" * 60)
    # input_array = jnp.asarray([0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50])
    input_array = np.linspace(0.001, 0.03, 10)
    ...
    solvers = {
        "Bisection": optx.Bisection(rtol=1e-3, atol=1e-3),
